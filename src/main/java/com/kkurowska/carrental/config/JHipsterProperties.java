package com.kkurowska.carrental.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "carrental@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "carrental API";

        private String description = "carrental API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "carrental";
